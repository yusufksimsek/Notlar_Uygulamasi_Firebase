...
import com.example.notlar_uygulamasi.databinding.ActivityDetayBinding
        ...
        when(item.itemId){
            ...
            R.id.action_duzenle ->{
                ...
                if(TextUtils.isEmpty(ders_adi)){
                    Snackbar.make(binding.toolbarNotDetay,"Ders Adini Giriniz",Snackbar.LENGTH_SHORT).show()
                    return false
                }
